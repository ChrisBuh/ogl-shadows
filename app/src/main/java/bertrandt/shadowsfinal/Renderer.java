...
import bertrandt.shadowsfinal.common.FPSCounter;
import bertrandt.shadowsfinal.common.MatrixHelper;
import bertrandt.shadowsfinal.common.RenderConstants;
import bertrandt.shadowsfinal.common.RenderProgram;
import bertrandt.shadowsfinal.common.TextureHelper;
import bertrandt.shadowsfinal.draw.DrawAgl;
import bertrandt.shadowsfinal.draw.DrawObj;
...
public class Renderer implements GLSurfaceView.Renderer {
    ...
    public Renderer(final Context shadowsActivity) {
        mContext = shadowsActivity;
    }
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        //arrange scene
        //center cube
        mCube = new Cube(mContext, new float[]{0.0f, 0.0f, 0.0f}, 3.0f, new float[]{0.0f, 0.0f, 1.0f, 1.0f});

        //4 small cubes on the ground plane
        mSmallCube0 = new Cube(mContext, new float[]{-4.0f, -3.9f, 4.0f}, 2.0f, new float[]{1.0f, 0.0f, 0.0f, 1.0f});
        mSmallCube1 = new Cube(mContext, new float[]{4.0f, -3.9f, 4.0f}, 2.0f, new float[]{0.0f, 1.0f, 0.0f, 1.0f});
        mSmallCube2 = new Cube(mContext, new float[]{4.0f, -3.9f, -4.0f}, 2.0f, new float[]{0.0f, 1.0f, 1.0f, 1.0f});
        mSmallCube3 = new Cube(mContext, new float[]{-4.0f, -3.9f, -4.0f}, 2.0f, new float[]{1.0f, 0.0f, 1.0f, 1.0f});
        ...
        mPCFShadowDynamicBiasProgram = new RenderProgram(R.raw.vertex_shader_shadow,
                R.raw.fragment_shader_shadow, mContext);

        mDepthMapProgram = new RenderProgram(R.raw.vertex_shader_depth_map,
                R.raw.fragment_shader_depth_map, mContext);
    ...
    private int scene_textureAttribute;
    private int scene_texture1Uniform;
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        scene_textureAttribute = GLES20.glGetAttribLocation(mActiveProgram, "aTexture");
        scene_texture1Uniform = GLES20.glGetUniformLocation(mActiveProgram, "uTexture");
    ...
    private void updateViewMatrices() {
        ...
        System.arraycopy(mViewMatrix, 0, viewMatrixForSkybox, 0, mViewMatrix.length);
    ...
    private void renderShadowMap() {
        ...
        mPlane.render(shadow_positionAttribute, 0, 0, 0, true);
        mSmallCube0.render(shadow_positionAttribute, 0, 0, 0, true);
        mSmallCube1.render(shadow_positionAttribute, 0, 0, 0, true);
        mSmallCube2.render(shadow_positionAttribute, 0, 0, 0, true);
        mSmallCube3.render(shadow_positionAttribute, 0, 0, 0, true);
    ...
    private void updateMvpMatrixForSkybox() {
        multiplyMM(tempMatrix, 0, viewMatrixForSkybox, 0, mModelMatrix, 0);
        multiplyMM(mMVPMatrix, 0, mProjectionMatrix, 0, tempMatrix, 0);
    }
